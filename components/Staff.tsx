      ...
      <div className="container mx-auto px-6 md:px-12">
        <ScrollReveal>
          <div className="text-center mb-24">
            <span className="font-eng text-accent tracking-[0.3em] text-sm block mb-6 uppercase">Expertise</span>
            <h2 className="text-2xl md:text-4xl font-mincho text-text tracking-widest mb-8">
              プロフェッショナルの矜持
            </h2>
            <p className="font-sans font-light text-base md:text-lg text-text-light max-w-2xl mx-auto leading-relaxed tracking-relaxed">
              ...
              <div className="group">
                <div className="relative aspect-[4/5] overflow-hidden rounded-sm mb-10 shadow-lg">
                  ...
                  <div className="absolute bottom-6 left-6 flex items-center gap-2 bg-white/90 backdrop-blur px-4 py-2 rounded-full transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700">
                    ...
                    <span className="text-xs font-sans tracking-widest text-text uppercase">Certified Expert</span>
                  </div>
                </div>
                
                <div className="text-center md:text-left">
                  <span className="font-eng text-accent text-base tracking-widest block mb-2">{staff.role}</span>
                  <h3 className="font-mincho text-2xl md:text-3xl text-text mb-6 tracking-[0.15em]">{staff.name}</h3>
                  <div className="h-[1px] w-12 bg-accent/30 mb-6 hidden md:block" />
                  <p className="font-sans font-light text-base md:text-lg leading-loose text-text-light text-left md:text-left italic tracking-relaxed">
                    {staff.message}
                  </p>
                </div>
              </div>
